namespace BlastCorpsEditor
{
    partial class BlastCorpsEditorForm
    {
        ...
        private void InitializeComponent()
        {
         ...
         this.statusStripSpring.Size = new System.Drawing.Size(956, 17);
         ...
         // 
         this.tableLayoutProperties.ColumnCount = 4;
         this.tableLayoutProperties.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle());
         this.tableLayoutProperties.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle());
         this.tableLayoutProperties.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle());
         this.tableLayoutProperties.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle());
         this.tableLayoutProperties.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle(System.Windows.Forms.SizeType.Absolute, 20F));
         this.tableLayoutProperties.Dock = System.Windows.Forms.DockStyle.Fill;
         this.tableLayoutProperties.Location = new System.Drawing.Point(3, 16);
         this.tableLayoutProperties.Name = "tableLayoutProperties";
         this.tableLayoutProperties.RowCount = 5;
